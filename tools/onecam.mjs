...
await p.evaluate(()=>{window.__demoTime=Date.parse('2000-01-01T00:00:00');window.__demoClockSpace=true;window.DSi.renderCam(17,16,16.5);});
await p.waitForTimeout(20);
fs.writeFileSync('/tmp/clone_cam165.png',Buffer.from((await p.evaluate(()=>document.getElementById('bottom').toDataURL('image/png'))).split(',')[1],'base64'));
